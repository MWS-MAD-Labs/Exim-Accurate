export const id = {
  ...
  dashboard: {
    ...
    pos: {
      ...
      allowanceRemaining: "Sisa bulan ini",
      allowanceUsed: "Terpakai bulan ini",
      ...
      workingDaysDescription: "Senin sampai Jumat adalah hari kerja secara default. Klik tanggal kerja untuk menjadikannya hari libur; klik tanggal merah untuk mengembalikannya.",
