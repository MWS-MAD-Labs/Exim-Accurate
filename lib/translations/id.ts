export const id = {
  ...
  dashboard: {
    ...
    pos: {
      cashierTitle: "Kasir POS",
      storeTitle: "Reservasi Toko Staf",
      analyticsTitle: "Analitik Penjualan POS",
      warehouseTitle: "Pengaturan Gudang POS",
      credential: "Kredensial Accurate",
      search: "Barcode atau nama barang",
      searchButton: "Cari",
      add: "Tambah",
      cart: "Keranjang",
      checkout: "Checkout",
      reserve: "Reservasi untuk diambil",
      staffEmail: "Email staf",
      pickupExpiry: "Batas waktu pengambilan",
      save: "Simpan gudang",
      warehouse: "Gudang",
      saleCompleted: "Penjualan berhasil",
      reservationCreated: "Reservasi berhasil dibuat",
      setupRequired: "Gudang POS belum dikonfigurasi",
      revenue: "Pendapatan",
      restockCost: "Biaya restock",
      profit: "Laba",
